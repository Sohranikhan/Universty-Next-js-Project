...
import { deleteProgram } from "../../../../../actions/FacultyAction"
    ...
    return (
        <div className="w-full h-auto">
            <Table>
                            ...
                            <TableCell className="overflow-visible">
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent className="w-full bg-background rounded">
                                        <DropdownMenuItem className="w-full"><Link href={`/dashboard/programs/${program._id}`} className="px-3 my-1 cursor-pointer flex items-center gap-2 py-1"><Edit size={18} /> Edit </Link>
                                        </DropdownMenuItem>
                                        <Confirm handler={deleteProgram} id={`${program._id}`} path="/dashboard/programs" />
                ...
                <TableFooter>
                    <TableRow>
                        <TableCell colSpan={3}>Totall Programs</TableCell>
