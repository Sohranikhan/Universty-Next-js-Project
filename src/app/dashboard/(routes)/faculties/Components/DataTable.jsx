...
const DataTable = async({data}) => {
    return (
        <div className="w-full h-auto">
            <Table>
                <TableCaption>
                    List of MCUT Faculties
                </TableCaption>
                <TableHeader>
                    <TableRow>
                        <TableHead className="w-[100px]">#</TableHead>
                        <TableHead>Faculty Name</TableHead>
                        <TableHead>Dean Name</TableHead>
                            ...
                            <TableCell className="overflow-visible">
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent className="w-full bg-background rounded">
                                        <DropdownMenuItem className="w-full"><Link href={`/dashboard/faculties/${faculty._id}`} className="px-3 my-1 cursor-pointer flex items-center gap-2 py-1"><Edit size={18} /> Edit </Link>
                                        </DropdownMenuItem>
                                        <Confirm handler={deleteFaculty} id={`${faculty._id}`} path="/dashboard/faculties" />
                ...
                <TableFooter>
                    <TableRow>
                        <TableCell colSpan={3}>Totall Faculties</TableCell>
